...
graph_name=$3
subgraph_counter=$4
python /path/to/tvm/src/runtime/contrib/metawarenn/metawarenn_lib/mwnnconvert/nnac.py --model $bin_path --out_dir $op_path"/nnac_op" --placeholder 224,224,3
...
if [ "$subgraph_counter" = "1" ]; then
  ...
  input_path="/path/to/tvm/src/runtime/contrib/metawarenn/metawarenn_lib/mwnnconvert/input/pkl"
fi
