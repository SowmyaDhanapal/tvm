...
if(USE_METAWARENN_CODEGEN STREQUAL "ON")
  ...
  find_library(MWNN_PB_LIB_DIR NAMES protobuf HINTS src/runtime/contrib/metawarenn/metawarenn_lib/lib)
  find_library(METAWARENN_LIB NAMES mwnn HINTS src/runtime/contrib/metawarenn/metawarenn_lib/lib)
  list(APPEND TVM_RUNTIME_LINKER_LIBS ${MWNN_PB_LIB_DIR} ${METAWARENN_LIB})
endif()
